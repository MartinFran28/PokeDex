...
// Este for recorre los pokemones de la tercera generacino y los pasa uno a uno como argumento de la funcion para mostrarlos
...
botonesAside.forEach( boton => boton.addEventListener( "click", ( event ) => {  // funcion para ejecutar el evento de click en los botones del aside
    ...
    for ( let i = 252; i <= 386; i++ ) {  // Recorriendo todos los elementos nevamente para filtrarlos tipo
        fetch(URL + i)
